                        ...
                        <div class="crypto-widget">
                            ...
                            <div class="crypto-widget__content">
                                <div class="crypto-wallet-overview">
                                    <h1 class="mdc-typography--headline2 crypto-margin-none crypto-display-flex mdc-theme--primary crypto-text-shadow crypto-wallet-overview__balance">
                                        0.00</h1>
                            ...
                            <div class="crypto-widget__content">
                                <ul class="crypto-border-list">
                                    <li class="crypto-border-list__item crypto-border-list__item--large crypto-wallet ">
                                        <!-- BTC WALLET -->
                                        <a href="{{route('wallet')}}" class="mdc-theme--on-surface">
                                            <h4 class="crypto-wallet__name mdc-typography--overline">BTC WALLET</h4>
                                            <h2 class="crypto-wallet__value mdc-typography--headline3">0.81215</h2>
                                    ...
                                    <li class="crypto-border-list__item crypto-border-list__item--large crypto-wallet ">
                                        <!-- BTC WALLET -->
                                        <a href="{{route('wallet')}}" class="mdc-theme--on-surface">
                                            <h4 class="crypto-wallet__name mdc-typography--overline">ETHER WALLET</h4>
                                            <h2 class="crypto-wallet__value mdc-typography--headline3">7.190</h2>
                                            <span class="crypto-wallet__stats crypto-wallet__stats--up mdc-typography--caption">0.00%</span>
                                    ...
                                    <li class="crypto-border-list__item crypto-border-list__item--large crypto-wallet ">
                                        <!-- BTC WALLET -->
                                        <a href="{{route('wallet')}}" class="mdc-theme--on-surface">
                                            <h4 class="crypto-wallet__name mdc-typography--overline">LITECOIN
                                                WALLET</h4>
                                            <h2 class="crypto-wallet__value mdc-typography--headline3">32.730</h2>
                                            <span class="crypto-wallet__stats crypto-wallet__stats--up  mdc-typography--caption">0.00%</span>
                        ...
                        <div class="crypto-widget">
                            <div class="mdc-layout-grid__inner">
                                <div class="mdc-layout-grid__cell--span-6">
                                    <h2 class="crypto-widget__heading mdc-typography--overline mdc-theme--primary">
                                        <span class="crypto-widget__heading-text">Live Updates</span>
                                        <span class="crypto-widget__heading-border"></span>
                                    </h2>
                                </div>
                                <div class="mdc-layout-grid__cell--span-6 crypto-hide-tablet crypto-hide-phone crypto-widget__actions">
                                    <a href="#" class="mdc-button mdc-button--raised">Bitcoin</a>
                                    <a href="#" class="mdc-button">Ethereum</a>
                                    <a href="#" class="mdc-button">Litecoin</a>
                                </div>
                            </div>
                            <div class="crypto-widget__content">
                                <div id="wallets-performance-chart"></div>
                            </div>
                        </div>
                        <div class="crypto-widget">
                            <div class="mdc-layout-grid__inner">
                            ...
                            <div class="crypto-widget__content crypto-overflow-x-auto">
                                <table class="mdl-data-table mdc-typography--overline">
                                    ...
                                    <tr class="crypto-transactions-list__item">
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric crypto-transactions-list__status crypto-transactions-list__status--pending">
                                            Pending
                                        </td>
                                        <td>
                                            <a href="#" class="crypto-transactions-list__item-toggle">
                                    ...
                                    <tr class="crypto-transactions-list__item">
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric crypto-transactions-list__status crypto-transactions-list__status--confirmed">
                                            Confirmed
                                        </td>
                                        <td>
                                            <a href="#" class="crypto-transactions-list__item-toggle">
                                    ...
                                    <tr class="crypto-transactions-list__item">
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric crypto-transactions-list__status crypto-transactions-list__status--rejected">
                                            Rejected
                                        </td>
                                        <td>
                                            <a href="#" class="crypto-transactions-list__item-toggle">
            ...
            <aside id="my-mdc-dialog"
                ...
                <div class="mdc-dialog__surface">
                    ...
                    <div id="my-mdc-dialog-description" class="mdc-dialog__body">
                        <div class="crypto-display-flex crypto-display-flex--end crypto-margin-bottom-big">
                            <div class="mdc-text-field crypto-display-flex__flexed mdc-text-field--fullwidth">
                                <input type="text" id="wallet-name" class="mdc-text-field__input"
                    ...
                    <footer class="mdc-dialog__footer">
                        <button type="button"
                                class="mdc-button mdc-dialog__footer__button mdc-dialog__footer__button--cancel">Cancel
                        </button>
                        <button type="button"
                                class="mdc-button mdc-dialog__footer__button mdc-dialog__footer__button--accept mdc-dialog__action">
                            Add
                        </button>
                    </footer>
                </div>
